...
<body>
 ...
 <!-- Hero Section Begin -->
    ...
    <!-- Map Begin -->
    <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.5884918492834!2d105.82662451473105!3d21.009126386009033!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac800f450807%3A0x419a49bcd94b693a!2zSOG7jWMgdmnhu4duIE5nw6JuIGjDoG5n!5e0!3m2!1svi!2s!4v1641481153561!5m2!1svi!2s" width="600" height="700" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        ...
        <div class="container">
            ...
            <form action="message.php" method="POST">
                <div class="row">
                    ...
                    <div class="col-lg-12 text-center">
                        <textarea placeholder="Nhập lời nhắn của bạn..." name="message" id="message"></textarea>
                        <button type="submit" id="gui" class="site-btn">Gửi</button>
                    </div>
                </div>
            </form>
        </div>
