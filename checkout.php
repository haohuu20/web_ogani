...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                ...
                <li>Miễn phí vận chuyển cho tất cả các đơn đặt hàng từ $99</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Rau</a></li>
                            <li><a href="#">Trái cây & hạt khô</a></li>
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6><span class="icon_tag_alt"></span> Bạn có mã giảm giá không? <a href="#">Click vào đây</a> để nhập mã của bạn</h>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    ...
                                    <li>Rau quả tươi <span>$151.99</span></li>
                                    <li>Chuối <span>$53.99</span></li>
                                </ul>
                                <div class="checkout__order__subtotal">Tổng giá trị sản phẩm <span>$750.99</span></div>
                                <div class="checkout__order__total">Thành tiền <span>$750.99</span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Bạn muốn tạo tài khoản?
