  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><strong> Quản lý TIN TỨC</strong></h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th style="text-align: center;">Mã blog</th>
                    <th style="text-align: center;">Tên người viết</th>
                ...
                <tbody>
                  <?php
                                            ...
                                            $sql_blog = "SELECT * FROM blog JOIN nguoidung on blog.manguoidung=nguoidung.manguoidung ";
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $row_blog['tennguoidung'];?></td>
                                            <td><strong><?php echo $row_blog['tieude'];?></strong></td> 
                                            <td><?php echo $row_blog['mota'];?></td>
                                            <td><?php echo $row_blog['noidung'];?></td>
                                            <td><?php echo $row_blog['ngaydang'];?></td>
                                      
                                            <td><a class="btn btn-success" href= "tin_tuc_sua.php?id=<?php echo $row_blog['mablog'];?>">Sửa</a></td>
                                            <td><a class="btn btn-danger" href= "tin_tuc_xoa.php?id=<?php echo $row_blog['mablog'];?>" id="xoa" onclick="xoa(this)">Xóa</a></td>
                                        </tr>
                                        <?php
                                            }
                                          }
        ...
        <a class="btn btn-primary btn-lg  btn-block btn-theme active" href = "tin_tuc_them_moi.php">Thêm mới blog</a>
        <!-- /row -->
      </section>
      <!-- /wrapper -->
    </section>
