...
<body>
  <section id="container">
    <?php 
            ...
            $sql = "
                INSERT INTO `sanpham` (`masp`, `tensp`, `dongia`, `soluong`, `anh`, `mota`,`maloaisp`) 
                VALUES (NULL, '".$ten_sp."', '".$gia_tien."', '".$so_luong."', '".$anh_minh_hoa."', '".$mo_ta."', '".$id_loaisp."')";

            // 3. Thực thi câu lệnh lấy dữ liệu mong muốn
            $tin_tuc =$ketnoi->query($sql);
