...
<head>
  ...
  <title>OGANI| Quản lý loại sản phẩm</title>
...
<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><strong>Quản lý các loại sản phẩm</strong></h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th style="text-align: center;">Ảnh loại sản phẩm</th>
                ...
                <tbody>
                  <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["anhloai"];?></td>
                                            <td><a href= "loaisp_sua.php?id=<?php echo $row["maloaisp"];?>" class="btn btn-success">Sửa</a></td>
                                            <td><a class="btn btn-danger" href= "loaisp_xoa.php?id=<?php echo $row["maloaisp"];?>" id="xoa" onclick = "xoa(this)">Xóa</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ;?>
        ...
        <a class="btn btn-primary btn-lg  btn-block btn-theme active" href = "loaisp_them_moi.php">Thêm mới sản phẩm</a>
        <!-- /row -->
      </section>
      <!-- /wrapper -->
    </section>
  ...
  <!-- xác nhận xem có muốn xóa loại sản phẩm không-->
