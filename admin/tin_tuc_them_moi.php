...
<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Thêm mới tin tức</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="tin_tuc_them_moi_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Tên người đăng</strong></h4></label>
                                                <input class="form-control" id="inputten" type="text"  name="txttenngdang" value="<?php echo $_SESSION['tentaikhoan'];?> " readonly/>
                                                <label for="inputEmail"><h4><strong>Tiêu đề</strong></h4></label>
                                                <input class="form-control" id="inputtieude" type="text"  name="txtTieuDe" />
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <textarea class="form-control tinymce"  name="txtNoiDung" id="txtNoiDung"></textarea>
                                                
                                            </div>
                  <div class="form-group">
                  <br>
                    <div class="col-lg-offset-2 col-lg-10">
                      <input class="btn btn-theme" type="submit" id="gui" name="btnSubmit" value="Thêm mới">
                      <a class="btn btn-theme04" type="button" href="tin_tuc.php">Thoát</a>
                    </div>
                  </div>
                </form>
              </div>
  ...
  <script type="text/javascript">
        $(document).ready(function() 
        {
            ...
            if ($("#txtAnhMinhHoa").val().trim() == "") {
                alert("Bạn chưa chọn ảnh minh họa")
                $("#txtAnhMinhHoa").focus()
                return false
                }
