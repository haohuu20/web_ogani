  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Cập nhật SẢN PHẨM ORGANI</h3>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <?php 
                ...
                $sanpham = $ketnoi -> query($sql);

                // 4. Hiển thị ra dữ liệu mà các bạn vừa lấy
                $row = $sanpham -> fetch_assoc();
            ;?>
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="san_pham_organic_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                      <label for="inputEmail"><h4><strong>Tên sản phẩm</strong></h4></label>
                      <input class="form-control" id="inputEmail" type="text"  name="txtTenSP" value="<?php echo $row["tensp"];?>"/>
                      
                  </div>
                  <div class="form-floating mb-3">
                      <label for="inputEmail"><h4><strong>Loại sản phẩm</strong></h4></label>
                      <select class="form-control" name="idloaisp" id="">
                      ...
                      <?php
                        ...
                        while ($row1 = mysqli_fetch_assoc($ketQuaTraVe)) {?>                            
                            <option value="<?php echo $row1['maloaisp']?>" <?php if($row['maloaisp'] == $row1['maloaisp'] ) echo "selected" ?>><?php echo $row1['tenloaisp'];?></option> 
                      <?php
                      }
                      ;?> 
                      </select>
                  ...
                  <div class="form-floating mb-3">
                      ...
                      <input class="form-control" id="txtAnhMinhHoa" type="file"  name="txtAnhMinhHoa" value=""/>
                      
                  </div>
                  <div class="form-floating mb-3">
                      <label for="inputEmail"><h4><strong>Giá tiền</strong></h4></label>
                      <input class="form-control" id="inputEmail" type="text"  name="txtGiaTien" value="<?php echo $row["dongia"];?>"/>
                      
                  </div>
                  <div class="form-floating mb-3">
                      <label for="inputEmail"><h4><strong>Số lượng</strong></h4></label>
                      <input class="form-control" id="inputEmail" type="text"  name="txtSoLuong" value="<?php echo $row["soluong"];?>"/>
                      
                  </div>
                  <div class="form-floating mb-3">
                      <label for="inputEmail"><h4><strong>Mô tả</strong></h4></label>
                      <textarea class="form-control tinymce"  name="txtMoTa" id="txtMoTa"><?php echo $row["mota"];?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-offset-2 col-lg-10">
                      <input type="hidden" name="txtID" value="<?php echo $row["masp"];?>">
