...
<head>
  ...
  <title>OGANI| Quản lý sản phẩm</title>
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><strong>Quản lý SẢN PHẨM ORGANI</strong></h3>
        <div class="row mb">
          <!-- page start-->
                ...
                <tbody>
                  <?php
                          ...
                          <tr>
                              ...
                              <td>
                                  <a class="btn btn-success" href= "san_pham_organic_sua.php?id=<?php echo $row["masp"];?>">Sửa</a>
                                  <a class="btn btn-danger" href= "san_pham_organic_xoa.php?id=<?php echo $row["masp"];?>" onclick = "xoa(this)">Xóa</a>
                              </td>
                          </tr>
                          <?php
                              }
        ...
        <a class="btn btn-primary btn-lg  btn-block btn-theme active" href = "san_pham_organic_them_moi.php">Thêm mới sản phẩm</a>
        <!-- /row -->
      </section>
      <!-- /wrapper -->
    </section>
