  ...
  <section id="container">
    <?php 
       session_start();
            ...
            $ma_nguoi_dang=$_SESSION['phienDangNhap'];
            $nguoi_dang=$_SESSION['tentaikhoan']  ;
            ...
            $sql = "
                INSERT INTO `blog` (`mablog`,`manguoidung`, `tieude`, `mota`, `noidung`, `anhminhhoa`, `ngaydang`) 
                VALUES (NULL, '".$ma_nguoi_dang."','".$tieu_de."',  '".$mo_ta."', '".$noi_dung."', '".$anh_minh_hoa."', CURRENT_TIMESTAMP)";
