  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Cập nhật TRÁI CÂY</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            ;?>
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="loaisp_sua_thuc_hien.php" enctype="multipart/form-data">
                                             <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Mã loại sản phẩm</strong></h4></label>
                                                <input class="form-control" id="maloaisp" type="text"  name="maloaisp" value="<?php echo $row["maloaisp"];?>" readonly/>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Tên loại sản phẩm</strong></h4></label>
                                                <input class="form-control" id="inputEmail" type="text"  name="tenloaisp" value="<?php echo $row["tenloaisp"];?>"/>
                                                
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                <label for="txtAnhMinhHoa"><h4><strong>Ảnh minh họa</strong></h4></label>
                                                <input class="form-control" id="txtAnhMinhHoa" type="file"  name="anhloai" value="<?php echo $row["anhloai"];?>"/>
                  ...
                  <br>
                    <div class="col-lg-offset-2 col-lg-10">
                      <input type="hidden" name="maloaisp" value="<?php echo $row["maloaisp"];?>">
